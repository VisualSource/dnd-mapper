...
import { DISPLAY_MAP_EVENTS, EDITOR_MAP_WINDOW_LABEL, MAP_WINDOW_LABEL } from "./consts";
...
export async function emitUpdateEvent<T extends keyof DisplayEventMap, P extends DisplayEventMap[T]>(type: T, payload: P) {
    await emitTo(MAP_WINDOW_LABEL, DISPLAY_MAP_EVENTS.Update, { type, data: payload });
}